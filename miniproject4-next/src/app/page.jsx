...
import { Box, Button, Card, Container, Typography, Pagination } from "@mui/material";
...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        // ✅ (필수급) 환경변수 기반으로 호출
        const response = await axios.get(`${BACKEND_BASE_URL}/api/v1/books/list`);
